#!/usr/bin/env Rscript
# Script for å estimere paramtrene for ukentlige data
...
params_nb <- weekly_data[, estimate_params_nb(battledeaths), by=country_names]
params_ln <- weekly_data[, estimate_params_ln(battledeaths), by=country_names]

save(params_nb, file="params_nb.RData")
save(params_ln, file="params_ln.RData")
